  ...
  return (
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        <h1 className="text-3xl font-bold font-headline">Your Snippets</h1>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <Link href="/new-snippet" className="flex">
       ...
       <Link href="/new-snippet" className="fixed bottom-8 right-8">
