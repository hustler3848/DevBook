    ...
    <div className="flex items-center justify-center min-h-screen bg-background p-4">
      <div className="w-full max-w-md">
        <Link href="/" className="flex justify-center items-center mb-6 text-foreground">
            ...
            <span className="text-2xl font-bold font-headline ml-2">CodeSnippr</span>
        </Link>
        <Card>
          ...
          <CardContent>
            <div className="space-y-4">
                ...
                <Button type="submit" className="w-full bg-gradient-to-r from-indigo-500 to-violet-500 text-white hover:opacity-90 transition-opacity">Login</Button>
            </div>
